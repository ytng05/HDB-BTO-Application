...
// Fields locked after SingPass retrieval — these come from authoritative gov sources
  ...
  <div class="surface step-card">
    ...
    <div class="singpass-retrieve">
      <button class="btn btn-singpass" type="button" :disabled="isRetrieving" @click="retrieveFromSingPass">
        <span v-if="isRetrieving">Retrieving&hellip;</span>
    ...
    <div class="form-grid">
      ...
      <div>
        <label class="field-label" for="income">Monthly Household Income</label>
        <input id="income" v-model="applicationStore.form.monthlyHouseholdIncome" class="field" type="number" />
      </div>
